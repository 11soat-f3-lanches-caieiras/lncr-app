...
public interface JpaMercadoPagoQrPostgresDatabase extends JpaRepository<JpaMercadopagoQrPostgresEntity, Integer> {
    ...
    Optional<JpaMercadopagoQrPostgresEntity> findByCustomerOrderId(@Param("customerOrderId") Integer customerOrderId);
    ...
    List<JpaMercadopagoQrPostgresEntity> findByStatusList(@Param("paymentStatusIdList") List<Integer> paymentStatusIdList);
}
