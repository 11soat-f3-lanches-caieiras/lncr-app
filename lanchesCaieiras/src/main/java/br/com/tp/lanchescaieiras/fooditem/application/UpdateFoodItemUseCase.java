...
public class UpdateFoodItemUseCase {
    ...
    public FoodItemDTO partialUpdateById(Integer foodItemId, FoodItemDTO foodItemDTO, FoodItemGatewayImpl foodItemGateway) {
        ...
        if (foodItemWasChanged) {
            return foodItemGateway.saveFoodItem(existFoodItem);
        }
        else {
