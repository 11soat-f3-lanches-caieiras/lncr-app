...
public class GetCustomerUseCase {
    ...
    public CustomerDTO getById(Integer id, CustomerGateway customerGateway, CustomerMapper customerMapper) {
    ...
    public CustomerDTO getByDocumentNumber(String documentNumber, CustomerGatewayImpl customerGateway, CustomerMapper customerMapper) {
    ...
    public List<CustomerDTO> getAll(Optional<Integer> limit, CustomerGatewayImpl customerGateway, CustomerMapper customerMapper) {
