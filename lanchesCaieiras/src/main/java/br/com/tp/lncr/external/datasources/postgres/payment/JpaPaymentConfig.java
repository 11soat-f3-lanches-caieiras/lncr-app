package br.com.tp.lncr.external.datasources.postgres.payment;
...
@EnableJpaRepositories(
        basePackages = "br.com.tp.lncr.external.datasources.postgres.payment.mercadopago",
...
public class JpaPaymentConfig {
    ...
    public LocalContainerEntityManagerFactoryBean postgresEntityManagerFactory(
        ...
        return builder
                ...
                .packages("br.com.tp.lncr.external.datasources.postgres.payment.mercadopago")
