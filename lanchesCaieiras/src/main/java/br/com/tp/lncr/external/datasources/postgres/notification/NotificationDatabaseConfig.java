package br.com.tp.lncr.external.datasources.postgres.notification;
...
@EnableJpaRepositories(
        basePackages = "br.com.tp.lncr.external.datasources.postgres.notification",
...
public class NotificationDatabaseConfig {
    ...
    public LocalContainerEntityManagerFactoryBean postgresEntityManagerFactory(
        ...
        return builder
                ...
                .packages("br.com.tp.lncr.external.datasources.postgres.notification")
