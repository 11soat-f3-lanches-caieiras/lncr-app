package br.com.tp.lncr.external.datasources.postgres.customerorder;
...
@EnableJpaRepositories(
        basePackages = "br.com.tp.lncr.external.datasources.postgres.customerorder",
...
public class JpaCustomerOrderConfig {
    ...
    public LocalContainerEntityManagerFactoryBean postgresEntityManagerFactory(
        ...
        return builder
                ...
                .packages("br.com.tp.lncr.external.datasources.postgres.customerorder")
