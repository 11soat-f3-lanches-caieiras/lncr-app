...
class CustomerOrderIntegrationImplTest {
    ...
    void deveAtualizarStatusCustomerOrderComSucesso() {
        ...
        try (MockedStatic<IntegrationUtil> mockedUtil = mockStatic(IntegrationUtil.class)) {
            ...
            assertDoesNotThrow(() -> {
                customerOrderIntegration.updateCustomerOrderStatus(123, "RECEIVED");
            });
    ...
    void deveAtualizarStatusCustomerOrderParaInProgress() {
        ...
        try (MockedStatic<IntegrationUtil> mockedUtil = mockStatic(IntegrationUtil.class)) {
            ...
            assertDoesNotThrow(() -> {
                customerOrderIntegration.updateCustomerOrderStatus(456, "PREPARING");
            });
    ...
    void deveAtualizarStatusCustomerOrderParaReady() {
        ...
        try (MockedStatic<IntegrationUtil> mockedUtil = mockStatic(IntegrationUtil.class)) {
            ...
            assertDoesNotThrow(() -> {
                customerOrderIntegration.updateCustomerOrderStatus(789, "READY");
            });
    ...
    void deveAtualizarStatusCustomerOrderParaDelivered() {
        ...
        try (MockedStatic<IntegrationUtil> mockedUtil = mockStatic(IntegrationUtil.class)) {
            ...
            assertDoesNotThrow(() -> {
                customerOrderIntegration.updateCustomerOrderStatus(101, "FINISHED");
            });
    ...
    void deveAtualizarStatusCustomerOrderParaCancelled() {
        ...
        try (MockedStatic<IntegrationUtil> mockedUtil = mockStatic(IntegrationUtil.class)) {
            ...
            assertDoesNotThrow(() -> {
                customerOrderIntegration.updateCustomerOrderStatus(202, "CANCELLED");
            });
    ...
    void deveAtualizarStatusComIdZero() {
        ...
        try (MockedStatic<IntegrationUtil> mockedUtil = mockStatic(IntegrationUtil.class)) {
            ...
            assertDoesNotThrow(() -> {
                customerOrderIntegration.updateCustomerOrderStatus(0, "RECEIVED");
            });
    ...
    void deveAtualizarStatusComStatusNulo() {
        ...
        try (MockedStatic<IntegrationUtil> mockedUtil = mockStatic(IntegrationUtil.class)) {
            ...
            assertDoesNotThrow(() -> {
                customerOrderIntegration.updateCustomerOrderStatus(123, null);
            });
