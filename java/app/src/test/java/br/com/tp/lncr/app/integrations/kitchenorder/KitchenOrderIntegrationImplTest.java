...
class KitchenOrderIntegrationImplTest {
    ...
    void deveCriarKitchenOrderComSucesso() {
        ...
        try (MockedStatic<IntegrationUtil> mockedUtil = mockStatic(IntegrationUtil.class)) {
            ...
            assertDoesNotThrow(() -> {
                kitchenOrderIntegration.createKitchenOrder(customerOrderDTO);
            });
    ...
    void deveCancelarKitchenOrderPorId() {
        ...
        try (MockedStatic<IntegrationUtil> mockedUtil = mockStatic(IntegrationUtil.class)) {
            ...
            assertDoesNotThrow(() -> {
                kitchenOrderIntegration.cancelKitchenOrderById(123);
            });
    ...
    void deveAtualizarStatusKitchenOrder() {
        ...
        try (MockedStatic<IntegrationUtil> mockedUtil = mockStatic(IntegrationUtil.class)) {
            ...
            assertDoesNotThrow(() -> {
                kitchenOrderIntegration.updateKitchenOrderById(123, "PREPARING", false);
            });
    ...
    void deveAtualizarStatusKitchenOrderComForceUpdate() {
        ...
        try (MockedStatic<IntegrationUtil> mockedUtil = mockStatic(IntegrationUtil.class)) {
            ...
            assertDoesNotThrow(() -> {
                kitchenOrderIntegration.updateKitchenOrderById(123, "READY", true);
            });
    ...
    void deveLancarExcecaoQuandoKitchenOrderNaoForEncontrado() {
        ...
        try (MockedStatic<IntegrationUtil> mockedUtil = mockStatic(IntegrationUtil.class)) {
            ...
            assertThrows(IntegrationException.class, () -> {
                kitchenOrderIntegration.getKitchenOrderByCustomerOrderId(999);
            });
