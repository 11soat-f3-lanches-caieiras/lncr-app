...
class JpaFoodItemRepositoryImplTest {
    ...
    void checkIfFoodItemExistsByNameReturnsTrue() {
        ...
        boolean result = repositoryImpl.existsByName("X-Bacon", jpaFoodItemRepository, jpaFoodItemMapper);
    ...
    void checkIfFoodItemExistsByNameReturnsFalse() {
        ...
        boolean result = repositoryImpl.existsByName("NonExistent", jpaFoodItemRepository, jpaFoodItemMapper);
