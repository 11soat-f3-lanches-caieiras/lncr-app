...
class JpaFoodItemMapperTest {
    ...
    void setUp() {
        ...
        jpaFoodItemImageEntity.id = 1;
        jpaFoodItemImageEntity.foodItemId = 10;
        jpaFoodItemImageEntity._data = "base64data";
        jpaFoodItemImageEntity.fileName = "image.jpg";
        jpaFoodItemImageEntity.fileExtension = "jpg";
        jpaFoodItemImageEntity.imageError = null;
    }
    ...
    void mapFoodItemImageDtoToJpaEntity() {
        ...
        assertNotNull(result);
        assertEquals(foodItemImageDTO.getId(), result.id);
        assertEquals(foodItemImageDTO.getFoodItemId(), result.foodItemId);
        assertEquals(foodItemImageDTO.get_data(), result._data);
        assertEquals(foodItemImageDTO.getFileName(), result.fileName);
        assertEquals(foodItemImageDTO.getFileExtension(), result.fileExtension);
        assertEquals(foodItemImageDTO.getImageError(), result.imageError);
    }
    ...
    void mapJpaEntityToFoodItemImageDto() {
        ...
        assertNotNull(result);
        assertEquals(jpaFoodItemImageEntity.id, result.getId());
        assertEquals(jpaFoodItemImageEntity.foodItemId, result.getFoodItemId());
        assertEquals(jpaFoodItemImageEntity._data, result.get_data());
        assertEquals(jpaFoodItemImageEntity.fileName, result.getFileName());
        assertEquals(jpaFoodItemImageEntity.fileExtension, result.getFileExtension());
        assertEquals(jpaFoodItemImageEntity.imageError, result.getImageError());
    }
    ...
    void mapJpaImageListToImageDtoList() {
        ...
        assertEquals(jpaFoodItemImageEntity.id, result.get(0).getId());
    }
    ...
    void mapImageDtoListToJpaImageList() {
        ...
        assertNotNull(result);
        assertEquals(1, result.size());
        assertEquals(foodItemImageDTO.getId(), result.get(0).id);
    }
