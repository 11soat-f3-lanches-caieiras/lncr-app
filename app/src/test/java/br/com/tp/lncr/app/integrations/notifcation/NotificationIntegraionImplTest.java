...
class NotificationIntegraionImplTest {
    ...
    void deveEnviarNotificacaoComSucesso() {
        ...
        assertDoesNotThrow(() -> {
            notificationIntegration.sendNotification("ORDER_READY", 123, "Pedido pronto para retirada");
        });
    }
    ...
    void deveEnviarNotificacaoComTipoNulo() {
        ...
        assertDoesNotThrow(() -> {
            notificationIntegration.sendNotification(null, 123, "Mensagem de teste");
        });
    }
    ...
    void deveEnviarNotificacaoComArtefactIdNulo() {
        ...
        assertDoesNotThrow(() -> {
            notificationIntegration.sendNotification("ORDER_READY", null, "Mensagem de teste");
        });
    }
    ...
    void deveEnviarNotificacaoComMensagemNula() {
        ...
        assertDoesNotThrow(() -> {
            notificationIntegration.sendNotification("ORDER_READY", 123, null);
        });
    }
    ...
    void deveEnviarNotificacaoComTodosParametrosNulos() {
        ...
        assertDoesNotThrow(() -> {
            notificationIntegration.sendNotification(null, null, null);
        });
    }
}
