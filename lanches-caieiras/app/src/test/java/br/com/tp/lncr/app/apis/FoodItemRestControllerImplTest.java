...
import br.com.tp.lncr.app.apis.fooditem.FoodItemRestControllerImpl;
...
class FoodItemRestControllerImplTest {
    ...
    void deveCriarFoodItemComSucesso() {
        ...
        assertEquals(foodItemDTO, response.getBody().get_content());
    ...
    void deveRetornarTodosFoodItemsSemFiltros() {
        ...
        assertNotNull(response.getBody());
        assertEquals(foodItems, response.getBody().get_content());
    ...
    void deveAtualizarFoodItemParcialmente() {
        ...
        assertEquals(HttpStatus.OK, response.getStatusCode());
        assertNotNull(response.getBody());
        assertEquals(updatedFoodItem, response.getBody().get_content());
    ...
    void deveRetornarImagensPorFoodItemIdSemDados() {
        ...
        assertEquals(HttpStatus.OK, response.getStatusCode());
        assertNotNull(response.getBody());
        assertEquals(images, response.getBody().get_content());
