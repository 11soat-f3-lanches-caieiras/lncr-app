...
import br.com.tp.lncr.app.apis.kitchenorder.KitchenOrderRestControllerImpl;
import br.com.tp.lncr.app.commons.model.ResponseListModel;
import br.com.tp.lncr.app.commons.model.ResponseModel;
import br.com.tp.lncr.app.configs.KitchenOrderConfig;
import br.com.tp.lncr.app.dataproxy.KitchenOrderDataProxy;
...
class KitchenOrderRestControllerImplTest {
    ...
    void deveRetornarKitchenOrderPorIdSemFoodItems() {
        ...
        assertNotNull(response.getBody());
        assertEquals(kitchenOrderDTO, response.getBody().get_content());
